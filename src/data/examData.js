...
{ q: "Coulomb's law is only true for point charges whose sizes are", options: ["very small","large","very large","medium"], answer: "very small" },
...
{ q: "In an adiabatic process:", options: ["The absorbed as heat equals the change in internal energy","The energy absorbed as heat equals the work done by the system on its environment","The work done by the environment on the system equals the change in internal energy","The energy absorbed as heat equals the work done by the environment on the system"], answer: "The work done by the environment on the system equals the change in internal energy" },
{ q: "For a heat engine operating between a high temperature TH and a low temperature TC, the efficiency ɛ is given by:", options: ["ɛ = (TH+TC)/TH","ɛ = 1+(TC/TH)","ɛ = (TH-TC)/TC","ɛ = 1-(TC/TH)"], answer: "ɛ = 1-(TC/TH)" },
{ q: "The ratio of the size of image to the size of object:", options: ["Angular magnification","Resolving power","Critical angle","Linear magnification"], answer: "Linear magnification" },
{ q: "The phenomena in which a material emits different colours after being exposed to a specific light color is:", options: ["Fluorescence","Reflection","Phosphorescence","Refraction"], answer: "Fluorescence" },
